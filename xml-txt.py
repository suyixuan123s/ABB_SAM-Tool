...
#     parser.add_argument('--voc-dir', type=str, default='E:/ABB/AI/SAM-Tool/dataset/voc')
#     parser.add_argument('--save-dir', type=str, default='E:/ABB/AI/SAM-Tool/dataset/yolo')
...
#     else:
#         voc_dir = 'E:/ABB/AI/SAM-Tool/dataset/voc'
#         save_dir = 'E:/ABB/AI/SAM-Tool/dataset/yolo'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--voc-dir', type=str, default=r'E:\ABB\AI\SAM-Tool\dataset\voc')
    parser.add_argument('--save-dir', type=str, default=r'E:\ABB\AI\SAM-Tool\dataset\yolo')
    opt = parser.parse_args()
    if len(sys.argv) > 1:
        print(opt)
        parseXmlFilse(**vars(opt))
        ...
        voc_dir = r'E:\ABB\AI\SAM-Tool\dataset\voc'
        save_dir = r'E:\ABB\AI\SAM-Tool\dataset\yolo'
        parseXmlFilse(voc_dir, save_dir)
        print("image nums: {}".format(len(image_set)))
        print("category nums: {}".format(len(category_set)))
        print("bbox nums: {}".format(bbox_nums))