...
def save_anno_to_txt(images_info, save_path):
    ...
    # 获取保存路径的目录部分
    save_dir = os.path.dirname(os.path.join(save_path, txt_name))
...
def load_coco(anno_file, xml_save_path):
    ...
    with open(os.path.join(xml_save_path, "E:/ABB/AI/SAM-Tool/dataset/labels/classes.txt"), 'w') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-jp', '--json-path', type=str, default='E:/ABB/AI/SAM-Tool/dataset/annotations.json',
                        help='json path')
    parser.add_argument('-s', '--save-path', type=str, default='E:/ABB/AI/SAM-Tool/dataset/masks', help='txt save path')
    ...
    if len(sys.argv) > 1:
        ...
        json_path = 'E:/ABB/AI/SAM-Tool/dataset/annotations.json'
        txt_save_path = 'E:/ABB/AI/SAM-Tool/dataset/masks'
